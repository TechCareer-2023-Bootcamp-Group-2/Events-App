...
namespace eventsapp.dal.Concrete
{
    public class UnitOfWork : IUnitOfWork
    {
        ...
        private EventImagesRepository _eventImagesRepository;
        ...
        public IEventImagesRepository EventImagesRepo=>_eventImagesRepository=_eventImagesRepository??new EventImagesRepository(_ctx);
